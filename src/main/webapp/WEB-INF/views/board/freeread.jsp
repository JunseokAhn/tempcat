...
<body class="single is-preload">
	...
	<div id="wrapper">
		...
		<article class="post">
			...
			<span class="image featured">
				<img src="<c:url value="/img/${fBoard.savedfile }"/>" alt="" />
			</span>

			<p>${requestScope.fBoard.contents }</p>
			<footer>
				<%-- <ul class="stats">
			...
			<header id="myheader">
				<div class="title">
					<h2 class="col-6 col-12-xsmall">
						<form action="freplywrite" id="myreply" method="post" style="margin-bottom: 0px;">
							...
							<input type="hidden" id="freenum" name="freenum">
						</form>
					</h2>
				</div>
    ...
    function PreviousPage (e) {
        ...
        function sendreply () {
            ...
            //id, nickname, freenum, contents
            $('#id').val('${sessionScope.id}');
            $('#nickname').val('${sessionScope.nickname}');
            $('#freenum').val('${requestScope.fBoard.freenum}');
            ...
            /*//비동기식 댓글리드 > 실패 $.ajax({
                 ...
                 data : {
                     ...
                     freenum : '${requestScope.fBoard.freenum}',
                     contents : comment
                 },
            ...
            /*   function addHeart () {
                  var heart = ${requestScope.fBoard.heart}+1;
                  $('#heart').html(${requestScope.fBoard.heart+1 })
                  $.ajax({
                      url : 'freeheart',
                      data : {
                          heart : heart
        ...
        function updatereply (num) {
            ...
            h += "<form action='freplyupdate' id='myreply2' method='post' style='margin-bottom: 0px;''>"
            ...
            h += "<input type='hidden' id='freenum2' name='freenum'>"
            h += "</form>"
            h += "</h2>"
            h += "</div>"
            h += "<div class='meta'>"
